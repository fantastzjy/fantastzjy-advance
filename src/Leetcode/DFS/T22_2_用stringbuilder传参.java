...
public class T22_2_用stringbuilder传参 {
    ...
    public static void main(String[] args) {
        System.out.println(new T22_2_用stringbuilder传参().generateParenthesis(3));
    ...
    public void backtrack(StringBuilder track, int l, int r) {
        ...
        //撤销选择
        track.deleteCharAt(track.length() - 1);//LinkedList的方法
